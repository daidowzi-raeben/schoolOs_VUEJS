    ...
    <div class="p-3 jelly-tab">
      <ul v-if="LOGIN_STUDENT" class="flex">
        <li v-if="LOGIN_STUDENT.t_todo_name">
          <nuxt-link to="/parttime-list/0">알바고</nuxt-link>
        </li>
        <li v-if="LOGIN_STUDENT.t_todo_name" class="is_active">나의 알바고</li>
      </ul>
    </div>
    ...
    <div class="content">
      <div class="content__body m-t-1 h60">
        <div v-if="LOGIN_STUDENT" class="account">
          <h3 v-if="LOGIN_STUDENT.t_todo_name">나의 알바</h3>
        </div>
        <div
          v-if="!GET_AXIOS_CALLBACK_GETTER.albaList"
          class="quest__content m-t-3"
        >
          <div class="p-5 text-center font-14">알바를 구해보세요.</div>
        </div>
        <div
          v-if="GET_AXIOS_CALLBACK_GETTER.albaList"
          class="quest__content m-t-3"
